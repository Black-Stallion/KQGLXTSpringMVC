		...
		<div id="page-wrapper">
			<div class="panel panel-info"
				...
				<div class="panel-heading">
					<h2>
						考勤系统<b>></b><strong>基本设置</strong><b>></b><strong>员工管理</strong><b>></b><strong>员工添加</strong>
					</h2>
				...
				<div class="panel-body no-padding" style="display: block;">
					<form id="form1" name="form1" onsubmit="return Check();"
						method="post" action="employee/emp?param=addEmployee">
						<table class="table table-bordered">
							...
							<tr>
								...
								<td><input class="cls_rad" type="radio" checked="checked"
									name="employeeGender" id="employeeGender" value="1" />男 &nbsp;
									<input class="cls_rad" type="radio" name="employeeGender"
									id="employeeGender" value="0" />女</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="cls_rad" type="radio" checked="checked"
									name="employeeStatc" value="1" />正常 &nbsp; <input
									class="cls_rad" type="radio" name="employeeStatc" value="0" />停用</td>
							</tr>
							<tr>

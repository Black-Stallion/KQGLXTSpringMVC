		...
		<div id="page-wrapper">
			<div class="panel panel-info"
				...
				<div class="panel-heading">
					<h2>
						考勤系统<b>></b><strong>请假单管理</strong><b>></b><strong>修改请假单</strong>
					</h2>
						...
						<table class="table table-bordered">
								...
								<td><select id="noteType" name="noteType"
									style="width: 215px;">
										<c:forEach var="item" items="${list2}">
											<c:choose>
												<c:when test="${item.typeId==notes.noteType }">
							...
							<tr>
								...
								<td><textarea rows="3" cols="40" id="presidentSign"
										name="presidentSign">${notes.presidentSign }</textarea></td>
							</tr>
							<tr>
								<td>总裁意见:</td>

		...
		<div id="page-wrapper">
			<div class="panel panel-info"
				...
				<div class="panel-heading">
					<h2>
						考勤系统<b>></b><strong>单据管理</strong><b>></b><strong>倒休单管理</strong>
					</h2>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2>倒休单列表</h2>
					<h2 align="right">
						<a href="notes/ShiftHolidaysNoteAdd.jsp" class="actionBtn">添加</a>
					</h2>
				</div>
					...
					<div class="table-responsive">
						<table width="100%" border="0" cellpadding="8" cellspacing="0"
							...
							<tr>
								...
								<td>张三</td>
								<td>是</td>
								<td><a href="jsp/ShiftHolidaysNoteEdit.jsp">修改</a> | <a
							...
							<tr>
								...
								<td>张三</td>
								<td>是</td>
								<td><a href="notes/ShiftHolidaysNoteEdit.jsp">修改</a> | <a
									href="product_category.php?rec=del&cat_id=4">删除</a></td>
							</tr>
							<tr>
								<td>A001</td>

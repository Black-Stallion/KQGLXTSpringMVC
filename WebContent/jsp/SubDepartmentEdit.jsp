		...
		<div id="page-wrapper">
			<div class="panel panel-info"
				...
				<div class="panel-heading">
					<h2>
						考勤系统<b>></b><strong>基本设置</strong><b>></b><strong>部门管理</strong><b>></b><strong>子部门管理</strong><b>></b><strong>子部门修改</strong>
					</h2>
				...
				<div class="panel-body no-padding" style="display: block;">
					<form action="department/updateSub/savesubdepartment" method="post"
						...
						<table class="table table-bordered">
							<tr>
								<td><font style="color: red">*&nbsp;</font>子部门名称</td>
							...
							<tr>
								<td colspan="2"><input class="btn btn-info" type="submit"
									value="保存" name="btnSave" id="btnSave" /></td>
							</tr>
						</table>
					</form>
				</div>
